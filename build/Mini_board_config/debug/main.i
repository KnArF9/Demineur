...
const char accueil[] = {"Labo6 de Frank"};
...
demine(posX,posY);
if(demine(posX,posY) == 0 || gagne(&nb)== 1)
{
while(PORTBbits.RB1 != 0)
{
afficheTabMine();
...
{
char nombre=0;
if((ligne-1 >= 4 || ligne+1 <= 4) && (colonne-1 >= 20 || colonne+1 <= 20) )
{

if(m_tabMines[ligne-1][colonne-1]== 2)
{
nombre = nombre+1;
}
